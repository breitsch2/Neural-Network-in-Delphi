...
//type
  ...
  //public //Netzwerk erzeugen / initialisieren
    procedure {constructor} Create( pSizes: TStringList ); //overload;
    procedure Create1( pInputPath : String ); //overload;
    procedure {destructor} Destroy1; //override;
  //private
...
//-------- Create-New (public) -------------------------------------------------
procedure Create( pSizes: TStringList ); begin
...
procedure Create1( pInputPath : String ); begin
...
procedure {TNeuralNetwork.}Destroy1(); begin
...
begin //@main
  ...
  writeln(flots(calculateSigmoid(0.06868)));
